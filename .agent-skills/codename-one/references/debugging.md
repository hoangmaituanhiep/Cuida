...
| Command | Purpose |
| --- | --- |
| `stop in com.heip.Cuida.Cuida.runApp` | Breakpoint on a method entry. |
| `stop at com.heip.Cuida.LoginForm:42` | Breakpoint at source line 42. |
...
5. **Set the breakpoint, then continue**: at the `jdb >` prompt:
   ...
   ```
   stop at com.heip.Cuida.LoginForm:42
   cont
   ```
